...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Fire Alarm Management Dashboard" },
      { name: "description", content: "Real-time fire alarm monitoring, troubles tracking, and device management." },
      { property: "og:title", content: "Fire Alarm Management Dashboard" },
